export const colors = {
  white: {
    base:  '#ffffff', // Warna navigasi Home - Blog
    light: '#f0f0f0', // Warna judul post
    grey: '#98FB98', // warna link saat hover
    dark: '#a0afd7', // belum paham untuk apa
    /*
    base:  '#fff',
    light: '#f0f0f0',
    grey: '#cecece',
  ...
  black: {
    base:  '#333438', // judul post juga
    light: '#4b4e57', // kurang paham
    blue: '#2e3246', // kurang paham juga
  },
  primary: {
    base:  '#00FA9A',
    light: '#00FF7F',
